...
把cilist（CallInfoList）中的元素释放一半（cilist中都是无用的？），但是为什么释放一半？？？
*/
...
为lua_State创建一个寄存器表，这个表没有hash部分，只有数组部分
array[0]: MAIN_THREAD
array[1]: empty table
*/
