...
#define BITRAS (1 << 7)                                    //第8位为realasize的标记
#define isrealasize(t) (!((t)->flags & BITRAS))            //取第八位的值，如果为0: 证明被设置了norealasize，如果为1: 没有被设置norealasize
#define setrealasize(t) ((t)->flags &= cast_byte(~BITRAS)) //取低7位的值，第八位是被设置0的
#define setnorealasize(t) ((t)->flags |= BITRAS)           //第八位设置1
